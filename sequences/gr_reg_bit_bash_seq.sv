...
class gr_reg_single_bit_bash_seq extends uvm_reg_sequence #(uvm_sequence #(uvm_reg_item));

   // Variable: rg
   // The register to be tested
   uvm_reg rg;

   `uvm_object_utils(gr_reg_single_bit_bash_seq)

   function new(string name="gr_reg_single_bit_bash_seq");
     super.new(name);
   endfunction
   ...
   virtual task body();
      ...
      if (uvm_resource_db#(bit)::get_by_name({"REG::",rg.get_full_name()}, "NO_REG_TESTS",         0) != null ||
          uvm_resource_db#(bit)::get_by_name({"REG::",rg.get_full_name()}, "NO_REG_BIT_BASH_TEST", 0) != null )
            return;
...
class gr_reg_bit_bash_seq extends uvm_reg_sequence #(uvm_sequence #(uvm_reg_item));
   ...
   //
   protected gr_reg_single_bit_bash_seq reg_seq;
   
   `uvm_object_utils(gr_reg_bit_bash_seq)

   function new(string name="gr_reg_bit_bash_seq");
     super.new(name);
   endfunction
   ...
   virtual task body();
      ...
      reg_seq = gr_reg_single_bit_bash_seq::type_id::create("reg_single_bit_bash_seq");
